...
export const updateWeather = (lat, lon) => {
    ...
    fetchData(URL.currentWeather(lat, lon), function (currentWeather) {
        const {
          weather,
          dt: dateUnix,
          sys: { sunrise: surnriseUnixUTC, sunset: sunsetUnixUTC},
        ...
        card.innerHTML = `
          ...
          <div class="weaper">
            <div class="heading">${parseInt(temp)}&deg;<sup>c</sup></div>
        ...
        fetchData(URL.airPolution(lat, lon), function(airPolution){
          ...
          <div class="highlights-list">
            <div class="card card-sm highlight-card one">
              <h2 class="title-3">Air Quality Index</h2>
            ...
            <div class="card card-sm highlight-card tow">
              ...
              <div class="card-list">
                ...
                <div class="card-item">
                  ...
                  <div>
                    ...
                    <p class="title-1">${module.getTime(surnriseUnixUTC, timezone)}</p>
                  </div>
                </div>
            ...
            <div class="card card-sm highlight-card">
              <h3 class="title-3">Feels_like</h3>
